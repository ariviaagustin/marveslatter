        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <table>
                <tr>
                    ...
                    <?php
                      ...
                      $where = array('id_data_pegawai'=>$id_pegawai);
                      $peg = $this->M_all->selectX('data_pegawai', $where)->row();
                      $id_tujuan_sem = $peg->jabatan;
                      $where_sem = array('id_sem'=>$detail_sem->id_sem, 'id_tujuan_sem'=>$id_tujuan_sem);
                      $sm = $this->M_all->selectX('tbl_sem_detail', $where_sem)->row();

                      $where_tp = array('id_data_pegawai'=>$sm->asal_dispo);
                      $peg_tp = $this->M_all->selectX('data_pegawai', $where_tp)->row();
                    ?>
                    <td><span class="btn btn-success">Disposisi dari - <?php echo $peg_tp->nama_pegawai;?></span></td>
                </tr>
                <tr>
                    <th>Nomor Surat</th>
                    <td> : </td>
              ...
              <form class="form-horizontal" action="<?php echo site_url('Surat_eksternal_masuk/aksi_disposisi_lanjutan_akhir'); ?>" method = "post" enctype="multipart/form-data">
                <div class="card-body">
