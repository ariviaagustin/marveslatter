          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Form Ubah Aksi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?php echo site_url('Master_data/aksi_surat_ubah'); ?>" method = "post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama Aksi</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="aksi" placeholder="Nama Aksi" value="<?= $aksi->aksi; ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%;" name="status_aksi">
                        <option value="1" <?php if($aksi->status_aksi == 1) { echo "selected"; } ?>>Aktif</option>
                        <option value="0" <?php if($aksi->status_aksi == 0) { echo "selected"; } ?>>Tidak Aktif</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer">
                  <input type="hidden" name="id" value="<?= $aksi->id_aksi; ?>">
