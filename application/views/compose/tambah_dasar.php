          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Form Tambah Dasar</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?php echo site_url('Compose/tambah_dasar_aksi'); ?>" method = "post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Dasar</label>
                      <div class="col-sm-10">
                          <textarea class="form-control" name="ket_dasar" required autofocus cols="2" rows="2"></textarea>
