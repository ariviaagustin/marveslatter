...
<html>
<head>
  <title>MARVES-LETTER | Not Access</title>
...
<body>
    ...
    <p id="text">Anda Tidak Memiliki Akses Ke Halaman ini</p>
    <a href="<?= site_url('Beranda'); ?>" class = "btn btn-danger" id = "credit"><< Kembali Ke Beranda</a>
</body>
</html>
