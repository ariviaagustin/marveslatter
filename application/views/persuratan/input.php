...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Input Identitas Surat Eksternal Masuk</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= site_url('Entry_persuratan/'); ?>">Input Identitas</a></li>
              <li class="breadcrumb-item active">Input Identitas Surat Eksternal Masuk</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Form Input Identitas Surat Eksternal Masuk</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="row">
                <div class="col-md-3">
                      <ul class="notes">
                        <li>
                            <div class="rotate-2 lazur-bg">
                                ...
                                <h4 style="margin-top: 10px; text-align: center;">Informasi Surat</h4>
                                <p style="margin-top: 10px;">
                                  Dari : <?php echo $detail->dari_pengirim.'<br>'; ?>
                                  Kepada : <?php echo $detail->kepada_tujuan.'<br>'; ?>
                                  No Surat : <?php echo $detail->nomor_surat.'<br>'; ?>
                                  Tgl Diterima : <?php echo indonesian_date($detail->tanggal_diterima); ?>
                                </p>
                            </div>
                        </li>  
                      </ul>
                  ...
                  <div class="col-md-9">
                    <form class="form-horizontal" action="<?php echo site_url('Entry_persuratan/aksi_ubah'); ?>" method = "post">
                      <div class="card-body">
                        <div class="form-group row">
                          <label class="col-sm-2 col-form-label">Dari Pengirim</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="dari_pengirim" placeholder="Nama Pengirim" required autofocus>
                          </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Jenis Tujuan</label>
                            <div class="col-sm-10">
                              <select required class="form-control select2" style="width: 100%;" name="id_jenis_tujuan" id="id_jenis_tujuan" onchange="myFunction()">
                        ...
                        <div class="form-group row" style="display: none;" id="personal" >
                          ...
                          <div class="col-sm-10">
                            <select class="form-control select2" style="width: 100%;" name="tujuan_surat_ke[]" multiple="multiple" id="per">
                        ...
                        <div class="form-group row" style="display: none;" id="jabatan">
                          <label class="col-sm-2 col-form-label">Kepada</label>
                          <div class="col-sm-10">
                              <select class="form-control select2" style="width: 100%;" name="tujuan_surat_ke[]" multiple="multiple" id="jab">
                        ...
                        <div class="form-group row" style="display: none;" id="bag_unit">
                          <label class="col-sm-2 col-form-label">Kepada</label>
                          <div class="col-sm-10">
                            <select class="form-control select2" style="width: 100%;" name="tujuan_surat_ke[]" multiple="multiple" id="bag">
                        ...
                        <div class="form-group row" style="display: none;" id="unit">
                          <label class="col-sm-2 col-form-label">Kepada</label>
                          <div class="col-sm-10">
                            <select class="form-control select2" style="width: 100%;" name="tujuan_surat_ke[]" multiple="multiple" id="u">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="date" class="form-control" name="tgl_surat_diterima" required>
                          </div>
                        </div>
